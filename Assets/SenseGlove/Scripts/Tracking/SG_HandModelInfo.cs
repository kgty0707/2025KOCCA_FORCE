...
namespace SG
{
    ...
    public class SG_HandModelInfo : MonoBehaviour
    {
        ...
        public Vector3 WristPosition
        {
            get
            {
                return wristTransform != null ? wristTransform.position : Vector3.zero;
            }
        }

        /// <summary> 손목(Wrist)의 회전값을 반환 (EulerAngles) </summary>
        public Vector3 WristRotation
        {
            get
            {
                return wristTransform != null ? wristTransform.rotation.eulerAngles : Vector3.zero;
            }
        }
